                            ...
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>{{ $confirmed }}</h6>
                                            <span class="text-success small pt-1 fw-bold">{{ ($reg_stage == 0) ? 0 : number_format((($confirmed/$reg_stage) * 100), 2) }}%</span> <span class="text-muted small pt-2 ps-1">Confirmed</span>
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>{{ $total_beds }}</h6>
                                            <span class="text-danger small pt-1 fw-bold">{{ ($total_beds == 0) ? 0 : number_format((($beds_occupied/$total_beds) * 100), 2) }}%</span> <span class="text-muted small pt-2 ps-1">Occupied</span>
